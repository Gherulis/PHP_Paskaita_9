<!-- Parsisiųsti ir patobulinti 7 paskaitos kodą(https://github.com/motiejus1/7paskaita-VIGI35)
Naujam klientui turi būti galimybė pridėti nuotrauką(nuotraukos kelias įsirašo į JSON prie kliento, nuotrauka įsikelia į "uploads" aplanką).
Lentelėje atvaizduojama kliento nuotrauka, 150x150px dydžio, jei klientas nuotraukos neturi - atvaizduojama tokia nuotrauka(https://images.unsplash.com/photo-1611162616475-46b635cb6868?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2574&q=80)
Papildomai: 
Naujo kliento pridėjimas atsidaro modaliniame lange(https://getbootstrap.com/docs/5.0/components/modal/)
My work
